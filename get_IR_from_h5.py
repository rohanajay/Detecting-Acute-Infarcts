...
def main(args):
    ...
    print('')
    print('INFO')
    print('Enter the path to your model optimizer file mo_tf.py (Please do not include the file name)')
    print('Please make sure there are no spaces gives at the start')
    print('Please do not enter the path in quotation marks/ inverted commas')
    print('')
    cpy_path = input('Enter here : ')

    pb_file = './mri_predict.pb'
    output_dir =act_dir
    command = "python mo_tf.py --input_model " + act_dir + "/mri_predict.pb --input_shape (1,112,112,3) --output_dir " +  act_dir 
